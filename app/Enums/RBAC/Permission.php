...
enum Permission: string
{
  ...
  public function getDescription(): string
  {
    return match ($this) {
      ...
      self::CAN_IMPERSONATE_USERS => 
        'De gebruiker kan andere gebruikers imiteren, wat betekent dat ze als die gebruiker kunnen inloggen en het systeem kunnen gebruiken vanuit de geïmiteerde gebruiker.',
    };
  }
