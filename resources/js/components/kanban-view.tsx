...
export const KanbanBoard = ({ id, children, className }: KanbanBoardProps) => {
    ...
    return (
        <div
            className={cn(
                'flex size-full min-h-40 flex-col overflow-hidden rounded-md border border-border bg-card transition-colors',
                isOver && 'bg-accent/30',
                className,
            )}
            ref={setNodeRef}
        ...
        <>
            ...
            {activeCardId === id && (
                <t.In>
                    <Card
                        className={cn(
                            'cursor-grab gap-4 rounded-md border border-border bg-background p-2 shadow-md',
