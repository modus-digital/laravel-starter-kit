...
export const GanttContentHeader: FC<GanttContentHeaderProps> = ({
  ...
  return (
    <div
      className="sticky top-0 z-20 grid w-full shrink-0 bg-card/80 backdrop-blur-sm"
...
export const GanttSidebarHeader: FC = () => (
  <div
    className="sticky top-0 z-10 flex shrink-0 items-end justify-between gap-2.5 border-border border-b bg-card/80 p-2.5 font-medium text-muted-foreground text-xs backdrop-blur-sm"
    style={{ height: 'var(--gantt-header-height)' }}
  >
...
export const GanttSidebar: FC<GanttSidebarProps> = ({
  ...
  <div
    className={cn(
      'sticky left-0 z-30 h-max min-h-full overflow-clip border-border border-r bg-card/80 backdrop-blur-md',
      className
    )}
  ...
  return (
    ...
    <div
      className={cn(
        ...
        isColumnSecondary?.(index) ? 'bg-muted/20' : ''
      )}
...
export const GanttFeatureDragHelper: FC<GanttFeatureDragHelperProps> = ({
  ...
  return (
    <div
        className={cn(
          'group -translate-y-1/2 absolute top-1/2 h-full w-6 rounded-md outline-none cursor-col-resize! z-3',
...
export const GanttProvider: FC<GanttProviderProps> = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'gantt relative grid h-full w-full flex-none select-none overflow-auto rounded-lg border border-border bg-card',
          range,
          className
        )}
        ref={scrollRef}
