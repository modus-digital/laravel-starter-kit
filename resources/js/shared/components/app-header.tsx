...
export function AppHeader({ breadcrumbs = [] }: AppHeaderProps) {
    ...
    const rightNavItems: NavItem[] = [
        {
            title: t('navigation.labels.repository', 'Repository'),
            href: 'https://github.com/laravel/react-starter-kit',
            icon: Folder,
        },
        {
            title: t('navigation.labels.documentation', 'Documentation'),
                    ...
                    <div className="lg:hidden">
                        <Sheet>
                            ...
                            <SheetContent side="left" className="flex h-full w-64 flex-col items-stretch justify-between bg-sidebar">
                                <SheetTitle className="sr-only">{t('navigation.labels.navigation_menu', 'Navigation Menu')}</SheetTitle>
                    ...
                    <div className="ml-auto flex items-center space-x-2">
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent className="w-56" align="end">
                                <UserMenuContent user={auth.user} unreadNotificationsCount={unreadNotificationsCount} />
                            </DropdownMenuContent>
                        </DropdownMenu>
                    </div>
                </div>
