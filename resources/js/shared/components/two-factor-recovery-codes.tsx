        ...
        <Card>
            <CardHeader>
                <CardTitle className="flex gap-3">
                    ...
                    {t('settings.two_factor.recovery_codes.title')}
                </CardTitle>
                <CardDescription>{t('settings.two_factor.recovery_codes.description')}</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="flex flex-col gap-3 select-none sm:flex-row sm:items-center sm:justify-between">
                    <Button onClick={toggleCodesVisibility} className="w-fit" aria-expanded={codesAreVisible} aria-controls="recovery-codes-section">
                        ...
                        {codesAreVisible ? t('settings.two_factor.recovery_codes.hide') : t('settings.two_factor.recovery_codes.view')}
                    </Button>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        {t('settings.two_factor.recovery_codes.warning')}{' '}
                                        <span className="font-bold">{t('settings.two_factor.recovery_codes.warning_action')}</span> above.
                                    </p>
                                </div>
                            </>
                        )}
