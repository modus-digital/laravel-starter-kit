            ...
            {errors?.length ? (
                ...
                <>
                    ...
                    <div className="relative flex w-full items-center justify-center">
                        ...
                        <span className="relative bg-card px-2 py-1">{t('settings.two_factor.setup_modal.manual_entry')}</span>
                    </div>
    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                buttonText: t('settings.two_factor.setup_modal.close'),
            };
        }
        ...
        if (showVerificationStep) {
            return {
                ...
                buttonText: t('settings.two_factor.setup_modal.continue'),
            };
        }
