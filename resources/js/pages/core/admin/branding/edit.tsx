...
import { ImageCropModal } from '@/shared/components/ui/image-crop-modal';
...
export default function Edit({ branding }: PageProps) {
    ...
    const [logoPreview, setLogoPreview] = useState<string | null>(branding.logo ? `/storage/${branding.logo}` : null);
    const [faviconPreview, setFaviconPreview] = useState<string | null>(branding.favicon ? `/storage/${branding.favicon}` : null);
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            {logoPreview && (
                                                <div className="flex h-16 w-full items-center justify-center rounded border bg-muted/30">
                                                    <img src={logoPreview} alt="Logo preview" className="h-16 w-auto max-w-full object-contain" />
                                                </div>
                                            )}
                                            <div>
                                                <Button
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <Button type="button" variant="outline" size="sm" onClick={() => setPalettePreviewOpen(true)} className="w-full">
