        ...
        <AuthLayout title={t('auth.pages.forgot_password.title')} description={t('auth.pages.forgot_password.description')}>
            ...
            <div className="space-y-6">
                    ...
                    {({ processing, errors }) => (
                        <>
                            <div className="grid gap-2">
                                <Label htmlFor="email">{t('auth.pages.forgot_password.email')}</Label>
                                <Input
                                    id="email"
                                    type="email"
                                    name="email"
                                    autoComplete="off"
                                    autoFocus
                                    placeholder={t('auth.pages.forgot_password.email_placeholder')}
                                />
                ...
                <div className="space-x-1 text-center text-sm text-muted-foreground">
                    <span>{t('auth.pages.forgot_password.back_to_login')}</span>
                    <TextLink href={login()}>{t('auth.pages.login.page_title')}</TextLink>
                </div>
            </div>
        </AuthLayout>
    );
