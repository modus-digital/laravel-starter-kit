...
>
    <template x-for="toast in toasts" :key="toast.id">
        ...
        >
            ...
            @if($closeable)
                <button @click="toast.dispose()" aria-label="{{ __('common.close') }}" class="absolute right-0 p-2 focus:outline-none focus:outline-hidden rtl:right-auto rtl:left-0 {{ $alignment->is('bottom') ? 'top-3' : 'top-0' }}">
